...
Because the clause has at least one element with the value 1, the clause $\cup$ would output the value 1, and since all clause outputs the value 1, with the $\cap$ logic of CNF it will output 1, thus the SAT is satisfied.\\


Since the claim is proven, we have shown that SAT $\leqslant$$_{p}$ q8  and that q8 is NP-Hard.\\
Since it is NP and NP-Hard, we have shown that q8 is NP-Complete.\\
% ----------------------------------------------------------------                                                                               
% Answer ends                                                                                                                                    
% ----------------------------------------------------------------
\end{description}
